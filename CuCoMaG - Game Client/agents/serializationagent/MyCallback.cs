            ...
            if (answerquality > 2)
            {
                try
                {
                    ...
                    using (XmlWriter xw = XmlWriter.Create(sb, xws))
                    {
                        ...
                        XElement ResultPlayerName = new XElement("PlayerName", sessionArray[session].ElementAt(0).PlayerName);
                    ...
                    string filename = sessionArray[session].ElementAt(0).PlayerName + "_" + session + "_.xml";
